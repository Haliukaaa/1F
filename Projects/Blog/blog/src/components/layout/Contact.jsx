    ...
    <div>
      <div className="flex justify-between mt-[100px]">
        ...
        <div className="w-1/4 flex flex-col gap-7">
          ...
          <div>
            <p className="text-color"><span className="font-bold text-color">Email :</span> info@jstemplate.net</p>
            <p className="text-color"><span className="font-bold text-color">Phone :</span> 880 123 456 789</p>
          </div>
        </div>
        {/* link */}
        <div>
          <ul className="list-none text-color">
            <li>Home</li>
