      ...
      <div className="px-4 md:px-5 py-16 lg:px-20 bg-gray-50 flex flex-col">
        ...
        <div className="flex flex-col lg:flex-row gap-12 justify-between">
          <div className='flex justify-center'>
            <img className="w-[280px] h-[360px] object-cover lg:w-[400px] lg:h-[480px] border-8 border-white" src="./aboutme.jpg" alt="a vector image of a girl with black hair and a green sweater" />
          </div>
          <div className="text-container flex flex-col items-start gap-[16px] lg:w-1/2">
            <h1 className='font-bold text-2xl lg:text-3xl'>Curious about me? Here you have it:</h1>
